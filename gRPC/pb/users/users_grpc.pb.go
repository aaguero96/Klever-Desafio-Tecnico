...
type UserServiceClient interface {
	...
	Read(ctx context.Context, in *FilterName, opts ...grpc.CallOption) (*Users, error)
	ReadById(ctx context.Context, in *UserId, opts ...grpc.CallOption) (*User, error)
	Update(ctx context.Context, in *UpdateUserInfo, opts ...grpc.CallOption) (*UserId, error)
...
func (c *userServiceClient) Read(ctx context.Context, in *FilterName, opts ...grpc.CallOption) (*Users, error) {
	out := new(Users)
...
func (c *userServiceClient) ReadById(ctx context.Context, in *UserId, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
	err := c.cc.Invoke(ctx, "/proto.UserService/ReadById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) Update(ctx context.Context, in *UpdateUserInfo, opts ...grpc.CallOption) (*UserId, error) {
	out := new(UserId)
...
type UserServiceServer interface {
	...
	Read(context.Context, *FilterName) (*Users, error)
	ReadById(context.Context, *UserId) (*User, error)
	Update(context.Context, *UpdateUserInfo) (*UserId, error)
...
func (UnimplementedUserServiceServer) Read(context.Context, *FilterName) (*Users, error) {
...
func (UnimplementedUserServiceServer) Update(context.Context, *UpdateUserInfo) (*UserId, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedUserServiceServer) Delete(context.Context, *UserId) (*UserId, error) {
...
func _UserService_Read_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).Read(ctx, req.(*FilterName))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserService_ReadById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.UserService/ReadById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).Update(ctx, req.(*UpdateUserInfo))
	}
	return interceptor(ctx, in, info, handler)
}
